...
public class RolePermissions {
    ...
    public static boolean isAdmin(IMessage msg){
        return msg.getAuthor().getPermissionsForGuild(msg.getGuild()).contains(Permissions.ADMINISTRATOR);
    }

    public static String noPermission(){
        return ":no_entry_sign: You do not have permission for that command.";
    }
}
